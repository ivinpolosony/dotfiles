...
if status --is-interactive
	if test -d ~/D/JonGjengsetsSConfig/shell/.config/fish/functions 
		set fish_function_path $fish_function_path ~/D/JonGjengsetsSConfig/shell/.config/fish/functions
		# builtin source ~/dev/others/base16/templates/fish-shell/conf.d/base17.fish
		builtin source /~/D/JonGjengsetsSConfig/shell/.config/conf.d/base17.fish
	end
	if ! set -q TMUX
		exec tmux
	end
